...
export default function AppLayout({ children }) {
    ...
    const navAdmin = [
        ...
        { title: 'Lớp học', href: '/admin/classes', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m3-4h1m-1 4h1m-5 8H8a2 2 0 00-2-2V7a2 2 0 002-2h8a2 2 0 002 2v12a2 2 0 00-2 2h-4z" /></svg> },
        { title: 'Sinh viên', href: '/admin/students', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg> },
    ...
    const navStudent = [
        { title: 'Hồ sơ', href: '/student/profile', icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg> }
    ];
            ...
            <div className="flex flex-1 overflow-hidden max-w-[1600px] mx-auto w-full">
                ...
                <main className="flex-1 p-4 md:p-8 overflow-y-auto">
                    <div className="max-w-7xl mx-auto">
                        ...
                        {/* Khu vực bọc nội dung các trang, tạo độ nổi khối */}
            ...
            <div className="max-w-[1600px] mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="hidden md:flex items-center gap-3 border-l border-gray-200 dark:border-gray-700 pl-5">
                        ...
                        {/* Avatar giả lập (hoặc thay bằng ảnh thật) */}
...
function Banner({ type = 'success', message }) {
    ...
    return (
        <div className={`mb-6 p-4 rounded-2xl flex items-center gap-4 border shadow-sm ${
            isSuccess 
