...
export default function ResetPassword({ token, email }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0b1326] flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-colors duration-300 relative overflow-hidden">
            <Head title="Đặt lại mật khẩu | Cổng thông tin" />
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md z-10 animate-fade-in-up">
                <div className="flex justify-center mb-6">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-500 dark:from-primary dark:to-primary-container flex items-center justify-center shadow-lg shadow-indigo-500/30 dark:shadow-primary/20 transition-transform hover:scale-105 duration-300">
                        <span className="material-symbols-outlined text-4xl text-white">password</span>
                    </div>
                </div>
                ...
                <div className="bg-white/80 dark:bg-[#161f36]/80 backdrop-blur-xl py-8 px-8 sm:px-10 shadow-[0_8px_30px_rgb(0,0,0,0.05)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] sm:rounded-3xl border border-gray-200 dark:border-[#c7c4d8]/10 relative">
                    ...
                    <form className="space-y-5" onSubmit={submit}>
                        <div>
                            ...
                            <div className="mt-1 relative rounded-xl shadow-sm opacity-80 cursor-not-allowed">
                                ...
                                <input
                                    ...
                                    readOnly
                                    value={data.email}
                                    className="block w-full pl-10 pr-3 py-3 font-medium text-gray-500 dark:text-[#dae2fd]/70 bg-gray-100 dark:bg-[#31394d]/30 border border-gray-200 dark:border-[#c7c4d8]/10 rounded-xl sm:text-sm cursor-not-allowed"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            <label htmlFor="password_confirmation" className="block text-xs font-bold text-gray-700 dark:text-outline uppercase tracking-widest mb-1">
                                Xác nhận mật khẩu
                            </label>
                            <div className="mt-1 relative rounded-xl shadow-sm">
                                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <span className="material-symbols-outlined text-gray-400 dark:text-outline-variant text-lg">lock_check</span>
                                </div>
                                <input
                            ...
                            {errors.password_confirmation && (
                                <p className="mt-2 text-xs text-red-600 dark:text-rose-400">{errors.password_confirmation}</p>
                            )}
                        </div>
            ...
            <div className="fixed bottom-6 w-full text-center z-10 pointer-events-none">
                <p className="text-xs text-gray-400 dark:text-outline/70 font-medium">
                    &copy; {new Date().getFullYear()} Đại Học Lumina. Hệ sinh thái quản lý giáo dục.
                </p>
            </div>
        </div>
    );
